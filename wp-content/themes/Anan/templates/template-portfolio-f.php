...
#toolbar{position:fixed; z-index:3; right:10px; top:10px; padding:5px; background:url(<?php bloginfo( 'stylesheet_directory' ); ?>/js/fullscreen/fs_img_g_bg.png);}
#toolbar img{border:none;}
#img_title{position:fixed; z-index:3; right:10px; top:10px; padding:10px; background:url(<?php bloginfo( 'stylesheet_directory' ); ?>/js/fullscreen/fs_img_g_bg.png); color:#FFF; font-family: Arial, serif; font-size:24px; text-transform:uppercase; display:none;}
...
#thumbnails_wrapper{z-index:2; position:fixed; bottom:0; width:100%; background:url(<?php bloginfo( 'stylesheet_directory' ); ?>/js/fullscreen/empty.gif); /* stupid ie needs a background value to understand hover area */}
...
.nextImageBtn{right:20px; background:#000 url(<?php bloginfo( 'stylesheet_directory' ); ?>/js/fullscreen/nextImgBtn.png) center center no-repeat;}
.prevImageBtn{left: 50px; background:#000 url(<?php bloginfo( 'stylesheet_directory' ); ?>/js/fullscreen/prevImgBtn.png) center center no-repeat;}
-->
</style>
...
<div class="thumbScroller">
	<div class="container">
		<?php
			...
			{
			    $small_image_url = get_bloginfo( 'stylesheet_directory' ).'/images/000_70.png';
			    ...
			    if(!empty($photo->guid))
			    {
			    	...
			    	$small_image_url = get_bloginfo( 'stylesheet_directory' ).'/timthumb.php?src='.$image_url[0].'&amp;h=50&amp;w=50&amp;zc=1';
			    }
		?>
    	<div class="content">
