...
?>
	...
	<div id="message" class="error fade">
	<p style="line-height:1.5em"><strong>
		The path <?php echo $data_dir; ?> is not writable, please login with your FTP account and make it writable (chmod 777) otherwise image uploader won't work.
	</p></strong>
	</div>
	...
	?>
		...
		<div id="message" class="updated fade">
			...
			<ol>
				...
				<li>Setup galleries via Galleries > Add New</li>
			</ol>
		</p><br/>
		<p>
...
?>
	...
	?> 
			...
			<li id="<?php echo $sidebar; ?>"><?php echo $sidebar; ?> ( <a href="<?php echo $url; ?>" class="sidebar_del" rel="<?php echo $sidebar; ?>">Delete</a> )</li>
...
?>
	...
	<div id="<?php echo $value['id']; ?>_wrapper" style="margin-left:210px;width:500px;font-size:11px;margin-top:10px">
		...
		<?php if(empty($value['size'])) { ?>
			<img src="<?php echo get_stylesheet_directory_uri(); ?>/data/<?php echo get_option( $value['id'] ); ?>"/>
		<?php } else { ?>	
			<img src="<?php echo get_stylesheet_directory_uri(); ?>/timthumb.php?src=<?php echo get_stylesheet_directory_uri().'/data/'.get_option( $value['id'] ); ?>&amp;w=<?php echo $value['size']; ?>"/>
		<?php } ?>
		<br/>
	</div>
	<?php
...
?>
	...
	<div id="<?php echo $value['id']; ?>_wrapper" style="float:left;width:350px;font-size:11px;margin-right:25px">
	<select name="<?php echo $value['id']; ?>"
		id="<?php echo $value['id']; ?>">
		<?php foreach ($value['options'] as $key => $option) { ?>
		<option
	...
	<br/><div id="pp_sample_text">Sample Text</div>
	<br/><br/>
	
	<strong style="margin-left:10px">Add New Font (.js file):</strong><br/>
	...
	<div id="<?php echo $value['id']; ?>_wrapper" style="float:left;width:150px;font-size:11px">
		Open <a href="http://cufon.shoqolate.com/generate/">Cufon site</a> and generate font javascript file (.js) and upload it here to install your font.<br/><br/>
...
?>
	...
	<div class="rm_title">
	<h3><img
		src="<?php get_template_directory_uri()?>/functions/images/trans.png"
